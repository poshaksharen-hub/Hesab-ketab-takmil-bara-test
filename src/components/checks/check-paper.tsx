    ...
    return (
        <div className={cn("overflow-hidden rounded-lg shadow-lg h-full flex flex-col bg-slate-50 dark:bg-slate-900 border-2 border-gray-300 dark:border-gray-700", isCleared && "opacity-60")}>
            ...
            <div className="p-3 relative bg-gray-100 dark:bg-gray-800/50 flex justify-between items-start">
                ...
                <div className="text-right w-1/3 flex flex-col items-end pl-2">
            ...
            <div className="p-4 space-y-2 flex-grow flex flex-col text-sm">
                 ...
                 <div className="flex items-baseline gap-2 border-b-2 border-dotted border-gray-400 pb-1 font-body text-xs">
                    <span className="shrink-0">در وجه:</span>
                     <span className="font-handwriting font-bold text-sm">{payeeName}</span>
                    <span className="shrink-0 ml-4">هزینه برای:</span>
                     <span className="font-handwriting font-bold text-sm flex-grow">
                       {expenseForName}
                    </span>
                </div>
